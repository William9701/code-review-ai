...
class TypeScriptAnalyzer:
    ...
    def _check_todo_comments(self, file_path: str, content: str) -> List[Dict[str, Any]]:
        """Check for TODO/FIXME comments"""
        issues = []
        lines = content.split('\n')
    ...
    def _check_loose_equality(self, file_path: str, content: str) -> List[Dict[str, Any]]:
    ...
    def _check_error_handling(self, file_path: str, content: str) -> List[Dict[str, Any]]:
